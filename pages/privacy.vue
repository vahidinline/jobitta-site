...
<template>
  <v-container grid-list-xs>
    <v-layout row wrap>
      <v-flex pa-2 md5>
        <v-img class="sticky" :src="require('@/assets/img/privacy.png')"></v-img>
      </v-flex>
      <v-flex pa-2 md7>
        <div class="subtitle-1">
          <p>
            Thank you for choosing to be part of our community at Synergen Ventures Ltd, trading as ExpertGap (
            <b>“ExpertGap”, “we”, “us”, or “our”</b>). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our notice, or our practices with regards to your personal information, please contact us at
            <a
              href="mailto:connect@synergenventures.co.uk"
            >connect@synergenventures.co.uk</a>.
          </p>
          <p>When you visit our website expertgap.co.uk and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Sites or Apps and our services.</p>
          <p>
            This privacy notice applies to all information collected through our website (such as expertgap.co.uk), Instagram application, ("
            <b>Apps</b>"), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy notice as the "
            <b>Services</b>").
          </p>
          <p>
          ...
          <div class="item">
            ...
            <p>
              <b>In Short:</b> We may collect information regarding your geo-location, and Instagram permissions when you use our apps.
            </p>
            ...
            <p>● Instagram Permissions. We by default access your Facebook basic account information, including your name, email, gender, birthday, current city, and profile picture URL, as well as other information that you choose to make public. We may also request access to other permissions related to your account, and you may choose to grant or deny us access to each individual permission. For more information regarding Instagram permissions, refer to the Instagram Permissions Reference page.</p>
          </div>
          <div class="item">
            <h2>2. HOW DO WE USE YOUR INFORMATION?</h2>
            <p>
              <b>In Short: We process your information for purposes based on legitimate business interests, the fulfillment of our contract with you, compliance with our legal obligations, and/or your consent.</b>
            </p>
            ...
            <p>Below are some definitions that will help you understand the roles and responsibilities of Synergen Ventures:</p>
            <p>● “data controller” means a person who (either alone or jointly or in common with other persons) determines the purposes for which and the manner in which any personal information are, or are to be used.</p>
            <p>● “data processor”, in relation to personal information, means any person (other than an employee of the data controller) who processes the data on behalf of the data controller.</p>
            <p>If you provide the data and the instructions, then you are the data controller and Synergen Ventures is the data processor.</p>
            <p>If we determine the purposes for which we collect and use your personal information, then we are the Controller.</p>
            <p>We use the information we collect or receive:</p>
            <p>● To facilitate account creation and logon process. If you choose to link your account with us to a third party account (such as your Google or Instagram account), we use the information you allowed us to collect from those third parties to facilitate account creation and logon process for the performance of the contract.</p>
            ...
            <p>● Fulfill and manage your orders. We may use your information to fulfill and manage your orders, payments, returns, and exchanges made through the Services or Apps.</p>
            <p>
              ● To post testimonials. We post testimonials on our Services or Apps that may contain personal information. Prior to posting a testimonial, we will obtain your consent to use your name and testimonial. If you wish to update, or delete your testimonial, please contact us at
              <a
                href="mailto:connect@synergenventures.co.uk"
              >connect@synergenventures.co.uk</a>. and be sure to include your name, testimonial location, and contact information.
            </p>
            ...
            <p>● Request Feedback. We may use your information to request feedback and to contact you about your use of our Services or Apps.</p>
          ...
          <div class="item">
            ...
            <p>
              <b>In Short: We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations.</b>
            </p>
          ...
          <div class="item">
            ...
            <p>
              <b>In Short: We may use cookies and other tracking technologies to collect and store your information.</b>
            </p>
          ...
          <div class="item">
            ...
            <p>
              <b>In Short: Yes, we use Google Maps for the purpose of providing better service.</b>
            </p>
            <p>
              This website, mobile application, or Instagram application uses Google Maps APIs. You may find the Google Maps APIs Terms of Service
              <nuxt-link to="/terms">here</nuxt-link>. To better understand Google’s Privacy Policy, please refer to this
              <a
          ...
          <div class="item">
            ...
            <p>
              <b>In Short: We keep your information for as long as necessary to fulfill the purposes outlined in this privacy notice unless otherwise required by law.</b>
            </p>
          ...
          <div class="item">
            ...
            <p>
              <b>In Short: We aim to protect your personal information through a system of organizational and technical security measures.</b>
            </p>
          ...
          <div class="item">
            ...
            <p>
              <b>In Short: We do not knowingly collect data from or market to children under 18 years of age.</b>
            </p>
            <p>
          ...
          <div class="item">
            ...
            <p>
              <b>In Short: In some regions, such as the European Economic Area, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.</b>
            </p>
            ...
            <p>
              ...
              >here: http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm.</a>
            </p>
            <p>
          ...
          <div class="item">
            ...
            <p>
              <b>In Short: Yes, we will update this policy as necessary to stay compliant with relevant laws.</b>
            </p>
          ...
          <div class="item">
            ...
            <p>
              ...
              <a
                href="mailto:connect@synergenventures.co.uk"
              >connect@synergenventures.co.uk</a> or by post to:
            </p>
            <p>
              Synergen Ventures
              <br />__________
            ...
            <p>
              If you are a resident in the European Economic Area, the "data controller" of your personal information is Synergen Ventures Ltd. You can contact Synergen Ventures directly regarding the processing of your information, by email at
              <a
                href="mailto:connect@synergenventures.co.uk"
              >connect@synergenventures.co.uk</a>, by phone at +44 (0)2081919088, or by post to:
            </p>
            <p>
              Synergen Ventures Ltd
